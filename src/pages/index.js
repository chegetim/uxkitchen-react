  ...
  <Layout>
    ...
    <div className="ProductLanguage">
      ...
      <div className="ProductLanguageText">
        <p>"This is the idea,can't you just design it? Research will take time..."</p>
        <p>"Add this paragragh, the more the content the more its understandable..."</p>
        <p>"So you're a product designer? Please make this pop. Give it some joos..."</p>
        <p>"I know what the user wants, no need for testing, just launch the app..."</p>
        <p>"Just follow the manager's instruction, your design process seems like you're over complicating the matter..."</p>
        <p>"Let's do freemium, we'll figure out the financials later..."</p>
        <p>"OMG just thought of something really cool. Add this feature, I promise its the next big thing..."</p>
    ...
    <div className="AreYouInNeed">
      ...
      <Link to="/contact-us"><button>Let UX Kitchen save your day</button></Link>
    </div>
